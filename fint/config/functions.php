...
function getBalanceSheet($date) {
    $conn = getConnection();
    
    // Get assets
    $sql = "SELECT a.account_code, a.account_name, a.balance
            FROM accounts a

Now, let's update the database schema to include the necessary tables for user access logs and activity tracking:
